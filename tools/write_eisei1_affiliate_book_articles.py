    ...
    "affiliate-textbooks-recommend": {
        ...
        "sections": [
            ...
            (
                ...
                "社会人独学では、通勤中に読める分量か、週末にまとめて演習できる問題量かも判断材料になります。"
                "1冊に絞れない場合は、テキスト1冊＋過去問専門1冊の2冊構成も有効です（→ affiliate-problem-books 参照）。",
            ),
            (
                "3冊の選び方（タイプ別）",
            ...
            (
                ...
                "速習から入りたい場合は affiliate-beginner-material-set も参照してください。",
            ),
            (
                "テキストと一衛マスター過去問の併用",
                "テキストで論点を押さえたら、一衛マスターの過去問・一問一答で「本試験形式」の演習に移ります。"
                "分野別得点を記録し、足切りライン（科目40%）に届いていない分野をテキスト該当章に戻って復習するサイクルが効率的です。\n\n"
                "演習だけでは理解が浅い分野があれば、通信講座の併用も選択肢です（affiliate-online-course-compare）。",
            ),
            (
                "購入前チェックリスト",
                "購入前に以下を確認してください。\n"
        ...
        "faqs": [
            (
                ...
                "演習量が足りないと感じたら、affiliate-problem-books の過去問専門1冊を追加する構成がおすすめです。",
            ),
            (
    ...
    "affiliate-problem-books": {
        ...
        "faqs": [
            (
                ...
                "affiliate-textbooks-recommend のテキスト1冊と組み合わせる構成を推奨します。",
            ),
            (
                "問題集は何冊必要ですか？",
    ...
    "affiliate-beginner-material-set": {
        ...
        "sections": [
            ...
            (
                ...
                "全体像把握→テキスト1冊（affiliate-textbooks-recommend）→問題集→過去問、"
            ...
            (
                ...
                "affiliate-textbooks-recommend のテキスト1冊に移行します。"
